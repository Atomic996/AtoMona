...
// ستحتاج إلى تحديث هذه العناوين بالعناوين الفعلية لعملاتك على موناد تيست نت
export const TOKEN_ADDRESSES = {
    ...
    ATO: "0x...", // !!! تحتاج إلى وضع عنوان عقد عملة ATO الخاص بك هنا !!!
};
...
// !!! تحتاج إلى الحصول على الـ ABI الفعلي لرمز ATO الخاص بك إذا كان يحتوي على دوال مخصصة !!!
